# Литература -> Книга и Журнал
# 2 характеристики и 1 поведение в базовом, 1 доп и 2 доп поведения в наследниках.
# Создать таблицы Книга и Журнал. Сделать 5 разных запросов
